...
@section('content')
    ...
    <div class="flex justify-center px-8 py-2 m-2">
        <div class="w-full max-w-sm bg-white bg-white rounded-lg w-3/12 mt-10 ml-6 flex-wrap">
            {{ HTML::ul($errors->all()) }}
            {{ Form::model($wardrobes,array('route' => array('wardrobe.update',$wardrobes->id),'method' => 'PATCH','enctype'=>"multipart/form-data")) }}
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    {{ Form::text('name', Request::old('name', $wardrobes->clothingName),array('class' => 'bg-gray-200 appearance-none border-2 border-gray-400 rounded py-2 px-6 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-teal-400'))}}
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
