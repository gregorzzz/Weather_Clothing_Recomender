    ...
    <div class="w-full max-w-sm bg-white bg-white rounded-lg w-3/12 mt-10 ml-6 flex-wrap">
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3">
                ...
                <select class="form-control block appearance-none  bg-gray-200 border border-gray-200 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="material" id="material">
